...
import Trangtinhluong from "./TrangtinhluongQL"
import ViewLuong from "./ViewLuongQL"
import moment from 'moment';
import styles from './LuongQuanLy.module.css'
...
var Manggop=[]
            ...
            const Getallchitiethoadon = async () => {
                ...
                axios.get(url)
                        ...
                        const GetallchitietLuong = async () => {
                            ...
                            const url = `http://localhost:5001/LuongQL/c/${Tenchinhanh}`
                            axios.get(url)
                                      .then(response => {
                                          const result = response.data;
                                          const { status, message, data } = result;
  ...
  const url = `http://localhost:5001/QuanLy/c/${Tenchinhanh}`
  axios.get(url)
            .then(response => {
                const result = response.data;
                const { status, message, data } = result;
    ...
    <div>
      ...
      <div className='container'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col' style={{position:"relative" , top:"16px",left:"290px"}}>
