...
import styles from '.././ChiNhanh/Trangtinhluong.module.css'

// import {isToggled} from'../../features/ChiNhanh/ChiNhanh'
const TrangtinluongQL = ({closemodal, Tienthuong, Tienchuyencan}) => {
...
var Manglistluong=[]
 ...
 const handleclickchamcong = (item) => {
  ...
  axios.get(url)
        ...
        //   let soluonghoadon = 0;
          const hamgopmang = () => {
            ...
            for(let i=0; i<Data.length; i++) {
                ...
                for(let i=0; i<Data.length; i++) {
                for(let j=0; j< Manggop.length;j++){
               
                    if(Data[i]._id===Manggop[j]._id                       ){
                        ...
                        // const tongtienlai= oo + (2000000*Manggop[j].Ngaylam)/26 - Manggop[j].Ngaytre*100000;
                        const tongtienlai= (5000000*Manggop[j].Ngaylam)/26 - Manggop[j].Ngaytre*100000;
        ...
        const handleEdit = () =>{
            const url = `http://localhost:5001/QuanLy/${id}`
...
export default TrangtinluongQL;
